...
def get_embeddings_from_dataloader(loader: DataLoader,
    ...
    classes = os.listdir("data/TsinghuaDogs/val")
    ...
    for images_, labels_ in loader:
        ...
        embeddings, _ = model(images, text)
...
if __name__ == "__main__":
    ...
    batch_size: int = 32#config.get("batch_size", None)
    if not batch_size:
    ...
    reference_set = Dataset("/Users/nguyendangquang/master/DeepLearning/deep-metric-learning/data/TsinghuaDogs/train", transform=preprocess)
